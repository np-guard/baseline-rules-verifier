...
Connections allowed in C:\nevo\projects\baseline-rules-verifier\tests\allow-access-to-google.yaml which are not a subset of those in netpols\microservices-netpols.yaml:
